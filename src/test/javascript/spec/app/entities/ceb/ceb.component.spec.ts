...
import { CebComponent } from 'app/entities/ceb/ceb.component';
import { CebService } from 'app/entities/ceb/ceb.service';
import { Ceb } from 'app/shared/model/ceb.model';

describe('Component Tests', () => {
    describe('Ceb Management Component', () => {
        let comp: CebComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cebs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
