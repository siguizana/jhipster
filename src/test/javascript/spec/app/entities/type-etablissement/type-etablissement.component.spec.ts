...
import { TypeEtablissementComponent } from 'app/entities/type-etablissement/type-etablissement.component';
...
describe('Component Tests', () => {
    describe('TypeEtablissement Management Component', () => {
        let comp: TypeEtablissementComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypeEtablissementComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new TypeEtablissement(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.typeEtablissements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
