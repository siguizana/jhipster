...
import { CentreExamenComponent } from 'app/entities/centre-examen/centre-examen.component';
...
describe('Component Tests', () => {
    describe('CentreExamen Management Component', () => {
        let comp: CentreExamenComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CentreExamenComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.centreExamen[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
