...
import { EnseigneComponent } from 'app/entities/enseigne/enseigne.component';
...
describe('Component Tests', () => {
    describe('Enseigne Management Component', () => {
        let comp: EnseigneComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EnseigneComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.enseignes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
