...
import { ISanction, Sanction } from 'app/shared/model/sanction.model';
...
describe('Service Tests', () => {
    describe('Sanction Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SanctionService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Sanction(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Sanction', async () => {
                const returnedFromService = Object.assign(
                    {
                        libelleSanction: 'BBBBBB'
                    },
