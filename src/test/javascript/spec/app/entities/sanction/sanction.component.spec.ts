...
import { SanctionComponent } from 'app/entities/sanction/sanction.component';
...
describe('Component Tests', () => {
    describe('Sanction Management Component', () => {
        let comp: SanctionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SanctionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sanctions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
