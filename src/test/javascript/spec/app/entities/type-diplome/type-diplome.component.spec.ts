...
import { TypeDiplomeComponent } from 'app/entities/type-diplome/type-diplome.component';
...
describe('Component Tests', () => {
    describe('TypeDiplome Management Component', () => {
        let comp: TypeDiplomeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypeDiplomeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typeDiplomes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
