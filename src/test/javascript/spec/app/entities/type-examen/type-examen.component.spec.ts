...
import { TypeExamenComponent } from 'app/entities/type-examen/type-examen.component';
...
describe('Component Tests', () => {
    describe('TypeExamen Management Component', () => {
        let comp: TypeExamenComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TypeExamenComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.typeExamen[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
