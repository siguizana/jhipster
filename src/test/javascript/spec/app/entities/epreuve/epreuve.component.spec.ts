...
import { EpreuveComponent } from 'app/entities/epreuve/epreuve.component';
import { EpreuveService } from 'app/entities/epreuve/epreuve.service';
import { Epreuve } from 'app/shared/model/epreuve.model';

describe('Component Tests', () => {
    describe('Epreuve Management Component', () => {
        let comp: EpreuveComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EpreuveComponent, '')
                .compileComponents();
