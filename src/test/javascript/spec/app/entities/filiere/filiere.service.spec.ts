...
describe('Service Tests', () => {
    describe('Filiere Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FiliereService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Filiere(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Filiere', async () => {
            ...
            it('should update a Filiere', async () => {
                const returnedFromService = Object.assign(
                    {
                        libelle: 'BBBBBB'
                    },
            ...
            it('should return a list of Filiere', async () => {
                const returnedFromService = Object.assign(
                    {
                        libelle: 'BBBBBB'
                    },
