...
import { DispenseComponent } from 'app/entities/dispense/dispense.component';
...
describe('Component Tests', () => {
    describe('Dispense Management Component', () => {
        let comp: DispenseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DispenseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dispenses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
