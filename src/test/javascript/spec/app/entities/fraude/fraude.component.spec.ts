...
import { FraudeComponent } from 'app/entities/fraude/fraude.component';
import { FraudeService } from 'app/entities/fraude/fraude.service';
import { Fraude } from 'app/shared/model/fraude.model';

describe('Component Tests', () => {
    describe('Fraude Management Component', () => {
        let comp: FraudeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FraudeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.fraudes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
