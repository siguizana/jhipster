...
import { ICommune, Commune, TypeCommune } from 'app/shared/model/commune.model';
...
describe('Service Tests', () => {
    describe('Commune Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CommuneService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Commune(0, 'AAAAAAA', 'AAAAAAA', TypeCommune.RURALE);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Commune', async () => {
                const returnedFromService = Object.assign(
                    {
                        codeCommune: 'BBBBBB',
                        libelleCommune: 'BBBBBB',
