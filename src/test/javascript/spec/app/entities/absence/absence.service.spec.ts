...
describe('Service Tests', () => {
    describe('Absence Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Absence(0, 'AAAAAAA', currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Absence', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        dateAbsence: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Absence', async () => {
                const returnedFromService = Object.assign(
                    {
                        motifAbsence: 'BBBBBB',
                        dateAbsence: currentDate.format(DATE_FORMAT)
            ...
            it('should return a list of Absence', async () => {
                const returnedFromService = Object.assign(
                    {
                        motifAbsence: 'BBBBBB',
                        dateAbsence: currentDate.format(DATE_FORMAT)
            ...
            it('should delete a Absence', async () => {
