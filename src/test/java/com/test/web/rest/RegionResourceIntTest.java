...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_CODE_REGION = "AAAAAAAAAA";
    private static final String UPDATED_CODE_REGION = "BBBBBBBBBB";
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getCodeRegion()).isEqualTo(DEFAULT_CODE_REGION);
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].libelleRegion").value(hasItem(DEFAULT_LIBELLE_REGION.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.libelleRegion").value(DEFAULT_LIBELLE_REGION.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getCodeRegion()).isEqualTo(UPDATED_CODE_REGION);
