...
public class ProvinceResourceIntTest {
    ...
    private static final String DEFAULT_CODE_PROVINCE = "AAAAAAAAAA";
    private static final String UPDATED_CODE_PROVINCE = "BBBBBBBBBB";
    ...
    public static Province createEntity(EntityManager em) {
        Province province = new Province()
            .codeProvince(DEFAULT_CODE_PROVINCE)
    ...
    public void createProvince() throws Exception {
        ...
        assertThat(testProvince.getCodeProvince()).isEqualTo(DEFAULT_CODE_PROVINCE);
        assertThat(testProvince.getLibelleProvince()).isEqualTo(DEFAULT_LIBELLE_PROVINCE);
    }
    ...
    public void checkLibelleProvinceIsRequired() throws Exception {
        ...
        // set the field null
        province.setLibelleProvince(null);
    ...
    public void getAllProvinces() throws Exception {
        ...
        restProvinceMockMvc.perform(get("/api/provinces?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codeProvince").value(hasItem(DEFAULT_CODE_PROVINCE.toString())))
            .andExpect(jsonPath("$.[*].libelleProvince").value(hasItem(DEFAULT_LIBELLE_PROVINCE.toString())));
    }
    ...
    public void getProvince() throws Exception {
        ...
        restProvinceMockMvc.perform(get("/api/provinces/{id}", province.getId()))
            ...
            .andExpect(jsonPath("$.codeProvince").value(DEFAULT_CODE_PROVINCE.toString()))
            .andExpect(jsonPath("$.libelleProvince").value(DEFAULT_LIBELLE_PROVINCE.toString()));
    }
    ...
    public void updateProvince() throws Exception {
        ...
        updatedProvince
            .codeProvince(UPDATED_CODE_PROVINCE)
        ...
        Province testProvince = provinceList.get(provinceList.size() - 1);
        assertThat(testProvince.getCodeProvince()).isEqualTo(UPDATED_CODE_PROVINCE);
        assertThat(testProvince.getLibelleProvince()).isEqualTo(UPDATED_LIBELLE_PROVINCE);
    }
