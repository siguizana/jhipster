...
public class ReclamationResource {
     ...
     * @return the ResponseEntity with status 201 (Created) and with body the new reclamationDTO, or with status 400 (Bad Request) if the reclamation has already an ID
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the updated reclamationDTO,
     * or with status 400 (Bad Request) if the reclamationDTO is not valid,
     * or with status 500 (Internal Server Error) if the reclamationDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<ReclamationDTO> updateReclamation(@Valid @RequestBody ReclamationDTO reclamationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, reclamationDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the reclamationDTO, or with status 404 (Not Found)
     */
