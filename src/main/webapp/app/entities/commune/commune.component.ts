...
export class CommuneComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.communeService
            ...
            .subscribe(
                (res: HttpResponse<ICommune[]>) => this.paginateCommunes(res.body, res.headers),
    ...
    registerChangeInCommunes() {
        this.eventSubscriber = this.eventManager.subscribe('communeListModification', response => this.reset());
    }
    ...
    protected paginateCommunes(data: ICommune[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        for (let i = 0; i < data.length; i++) {
            this.communes.push(data[i]);
        }
    }
