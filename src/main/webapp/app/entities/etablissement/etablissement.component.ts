...
export class EtablissementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.etablissementService
            ...
            .subscribe(
                (res: HttpResponse<IEtablissement[]>) => this.paginateEtablissements(res.body, res.headers),
    ...
    trackId(index: number, item: IEtablissement) {
        return item.id;
    }
    ...
    protected paginateEtablissements(data: IEtablissement[], headers: HttpHeaders) {
