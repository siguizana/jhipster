...
export class ReclamationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.reclamationService
            ...
            .subscribe(
                (res: HttpResponse<IReclamation[]>) => this.paginateReclamations(res.body, res.headers),
    ...
    registerChangeInReclamations() {
        this.eventSubscriber = this.eventManager.subscribe('reclamationListModification', response => this.reset());
    }
